...
public class PostPorductV2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String imageUrl = imageProcessor.uploadImageToFolder(fileInputStream, Folder_Up.PRODUCT_UP);

            ProductDAO dao = new ProductDAO();
            ProductDTO product
                    = new ProductDTO(account.getUser_ID(), Integer.parseInt(categoryPost), title, content, imageUrl,
